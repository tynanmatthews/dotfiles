(()=>{var J={5286:(e,i,n)=>{"use strict";n.r(i),n.d(i,{default:()=>T});var a=n(9601),r=n.n(a),c=n(2609),h=n.n(c),v=h()(r());v.push([e.id,`
...
`,""]);const T=v},5685:(e,i,n)=>{"use strict";n.r(i),n.d(i,{default:()=>T});var a=n(9601),r=n.n(a),c=n(2609),h=n.n(c),v=h()(r());v.push([e.id,`
.headerDiv {
    display: flex;
    flex-direction: column;
}
...
`]}]}]}},mounted(){this.showOS()},methods:{onClick(_,g){let f="autoTrigger";const m=_[0];m.startsWith("AmazonQ_generate_suggestion")?f="autoTrigger":m.startsWith("AmazonQ_manual_invoke")?f="manualTrigger":f="unitTest";const y="python";t.emitTryExampleClick(y,f),t.openFile([_[0],_[1]])},async showOS(){this.osState=await t.getOSType()},activeTabFunction(_){this.activeTab=_,sessionStorage.setItem("activeTab",_.toString())}}});var l=S(1648),s=S(4407);const x=(0,s.Z)(d,[["render",z]]),u=(0,e.defineComponent)({name:"Getting_Started",components:{GenerateSuggestionTab:x},data(){return{bannerVisible:!0,active:parseInt(sessionStorage.getItem("active")||"0")}},mounted(){sessionStorage.setItem("active","1")},methods:{closeStatusBar(){this.bannerVisible=!1}}});var B=S(6512);const P=(0,s.Z)(u,[["render",r]]);const b=()=>(0,e.createApp)(P),k=b();k.mount("#vue-app"),window.addEventListener("remount",()=>{k.unmount(),b().mount("#vue-app")})})();var K=this;for(var j in R)K[j]=R[j];R.__esModule&&Object.defineProperty(K,"__esModule",{value:!0})})();
/*!
